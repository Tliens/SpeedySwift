...
public extension String {
    ...
    // 字符串安全提取
    /// SpeedySwift: Safely subscript string with index.
    ///
    ...
    /// SpeedySwift: Returns a string by padding to fit the length parameter size with another string in the end.
    ///
    ...
    /// SpeedySwift: Removes given suffix from the string.
    ///
